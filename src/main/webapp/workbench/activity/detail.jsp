	...
	function showRemarkList(){
		$.ajax({
			...
			success:function (data){
				...
				html+='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;" id="s'+n.id+'"> '+(n.editFlag== 0 ? n.createTime : n.editTime)+' 由'+(n.editBy== 0 ? n.createBy : n.editBy)+'</small>';
				html+='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
