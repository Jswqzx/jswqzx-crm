...
<script>
	...
	$(function (){
		...
		//	取得选中的阶段
			...
			var possibitity =json[stage];

			$("#create-possibility").val(possibitity)
		});
...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="玩游戏dd">
				<input type="hidden" value="7dbb8c90584642f485ecfcb7aef53d3e" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="Wq">
				<input type="hidden" value="1f6a5168993643c48743bf479b7e4499" name="contactsId">
			</div>
		</div>
